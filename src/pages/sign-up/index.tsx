import { FormControl, FormLabel, TextField } from "@channel.io/bezier-react";
import React from "react";

export const SignUp = () => {
  return (
    <div className="flex place-items-center min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
